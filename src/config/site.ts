export const siteConfig = {
    ...
    header: {
        ...
        navLinks: [
            ...
            { href: '#articles', label: '资讯', sectionId: 'articles' },
            { href: '#updates', label: '更新日志', sectionId: 'updates' },
            { href: '#video', label: '官方频道', sectionId: 'video' },
        ],
    },
    hero: {
    ...
    video: {
        ...
        title: 'Official Introduction Video',
    },
    footer: {
